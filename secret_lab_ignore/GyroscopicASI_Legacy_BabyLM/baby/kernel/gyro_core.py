...
class GyroEngine:
    ...
    def _compute_row_parity(self, state_int: int, row: int, frame: int | None = None) -> int:
    ...
    def emit_next_token(
        ...
        session_bucket_position: dict[tuple[int, int], dict[int, int]] | None = None,
        ...
        session_prev_by_ctx: dict[tuple[int, int, int], int] | None = None,  # NEW: Context-scoped predecessor
    ...
    def emit_next_from_state(self, state_int: int, **kwargs) -> tuple[int, int, dict[tuple[int, int], int], dict[tuple[int, int], int], dict[tuple[int, int], dict[int, int]], dict[tuple[int, int], int], dict[int, int]] | None:
    ...
    def _log_event(self, event_code: int, state_int: int, intron: int | None = None) -> None:
