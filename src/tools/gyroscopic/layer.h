...
/* Q1_0 weight view for Arc-1 MatMul (signs/scales live in ggml or packed blob). */
...
/* Request reset: embd Pi → (u6,v6) or GENE_MAC_REST. */
...
/* Debug ladders: GYRO_ATTN_LEVEL=0|1|2 (default 2), GYRO_FFN_LEVEL=0|1|2 (default 2). */
HQVM_EXPORT int hqvm_attn_level(void);
HQVM_EXPORT int hqvm_ffn_level(void);
