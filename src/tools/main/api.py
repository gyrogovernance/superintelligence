...
External connectors and public API helpers.

Provides:
    - Parse inbound data into GovernanceEvents, Grants
    - Serialize status/events for external APIs
"""
...
def event_from_dict(d: dict[str, Any]) -> GovernanceEvent:
    ...
    kernel_state24 = d.get("kernel_state24")
    ...
    return GovernanceEvent(
        ...
        kernel_state24=int(kernel_state24) if kernel_state24 is not None else None,
