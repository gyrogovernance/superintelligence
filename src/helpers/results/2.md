...
aQPU GyroMatMul batch=   1: torch 0.01ms, CPU packed 0.16ms (0.0x vs torch), CPU i32 0.12ms, OpenCL 0.19ms (0.0x vs torch, 0.8x vs CPU), OpenCL i32 0.26ms
aQPU GyroMatMul batch=  16: torch 0.06ms, CPU packed 0.29ms (0.2x vs torch), CPU i32 1.01ms, OpenCL 0.26ms (0.2x vs torch, 1.1x vs CPU), OpenCL i32 0.32ms
aQPU GyroMatMul batch=  64: torch 0.25ms, CPU packed 0.92ms (0.3x vs torch), CPU i32 7.37ms, OpenCL 0.42ms (0.6x vs torch, 2.2x vs CPU), OpenCL i32 0.45ms
aQPU GyroMatMul batch= 256: torch 1.34ms, CPU packed 3.89ms (0.3x vs torch), CPU i32 21.94ms, OpenCL 1.00ms (1.3x vs torch, 3.9x vs CPU), OpenCL i32 0.88ms
aQPU GyroMatMul batch=1024: torch 5.99ms, CPU packed 13.27ms (0.5x vs torch), CPU i32 67.60ms, OpenCL 3.74ms (1.6x vs torch, 3.6x vs CPU), OpenCL i32 2.66ms
aQPU GyroMatMul batch=4096: torch 21.95ms, CPU packed 53.57ms (0.4x vs torch), CPU i32 269.12ms, OpenCL 14.29ms (1.5x vs torch, 3.7x vs CPU), OpenCL i32 9.57ms
