...
const DOMAINS: Array<{
  ...
  { key: 'economy', label: 'Economy (Kernel)', sublabel: 'Structural medium / state' },
          ...
          {hasEventLog ? (
            <div className="mb-3 p-2 rounded bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800">
              <p className="text-sm text-blue-800 dark:text-blue-200">
                ...
                Per GGG hierarchy: Economy = Kernel (structural medium), Employment = Gyroscope (active work), Education = THM (measurements).
              </p>
            </div>
          ) : (
            <>
              ...
              <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1 mb-4 ml-4 list-disc">
                <li><strong>Economy (Kernel):</strong> Structural medium / state (CGM operations)</li>
