...
MU values may be mapped to international dollars as a purchasing-power language. This mapping is a legibility and fair-rate convention. It is not an exchange rate, not a peg, not a redemption promise, and not a labour theory of value.
...
The CSM abolishes the artificial scarcity of the settlement medium. Physical constraints on goods, ecology, and care remain real, but they are no longer governed primarily through monetary exclusion.
...
The **economy** domain covers infrastructure, routing, settlement, and circulation. It includes the movement of Moment-Units, the publication of structural records, and the maintenance of the settlement environment. It also includes governance of physical constraints through fair-use rules, rather than excluding people through purely monetary price escalation.
...
Tier 1 baseline occupation removes monetary exclusion independent of genealogical depth. Genealogy supports higher responsibility and specialist trust relationships, but it does not become a condition for baseline existence.
