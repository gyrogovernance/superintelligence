...
The Moments Economy test suite validates the complete chain from physical constants through the Router kernel to the economic medium. All 28 tests pass, confirming:
...
4. **Medium Integrity:** Shells, Archives, identity anchors, and meta-routing behave deterministically with tamper-evidence.
...
| `test_medium.py` | End-to-end medium correctness | 9 | Yes |
...
python -m pytest tests/test_medium.py -v -s
```
...
## Part V: Medium Integrity

### Shell and Archive Determinism

**File:** `test_medium.py::test_01_shell_and_archive_integrity`
...
**File:** `test_medium.py::test_02_horizon_structure_and_coverage`
...
**File:** `test_medium.py::test_03_trajectory_identity_scaling`
...
**File:** `test_medium.py::test_04_parity_commitment_and_reconstruction`
...
**File:** `test_medium.py::test_05_trajectory_tamper_detection`
...
**File:** `test_medium.py::test_06_dual_code_integrity`
...
**File:** `test_medium.py::test_07_meta_routing`
...
**File:** `test_medium.py::test_08_component_isolation_and_rollback`
...
**File:** `test_medium.py::test_09_kernel_inverse_stepping`
...
```
(.venv) PS F:\Development\superintelligence> python tests/test_medium.py   
...
PASSED
tests/test_medium.py::test_01_shell_and_archive_integrity PASSED
tests/test_medium.py::test_02_horizon_structure_and_coverage PASSED
tests/test_medium.py::test_03_trajectory_identity_scaling PASSED
tests/test_medium.py::test_04_parity_commitment_and_reconstruction PASSED
tests/test_medium.py::test_05_trajectory_tamper_detection PASSED
tests/test_medium.py::test_06_dual_code_integrity PASSED
tests/test_medium.py::test_07_meta_routing PASSED
tests/test_medium.py::test_08_component_isolation_and_rollback PASSED
tests/test_medium.py::test_09_kernel_inverse_stepping PASSED
...
### `test_medium.py` — Medium Correctness
