...
tests/test_medium.py::test_01_capacity_envelope_for_uhi
...
PASSED
tests/test_medium.py::test_02_shell_and_archive_integrity
...
PASSED
tests/test_medium.py::test_03_horizon_structure_and_coverage
=== HORIZON STRUCTURE AND COVERAGE ===
Horizon states: 256
Reachable (1-step): 65536
OK: 256 horizon anchors cover the 65,536-state bulk in 1 step
PASSED
tests/test_medium.py::test_04_trajectory_identity_scaling
...
PASSED
tests/test_medium.py::test_05_parity_commitment_and_reconstruction   
...
PASSED
tests/test_medium.py::test_08_meta_routing
...
PASSED
tests/test_medium.py::test_09_component_isolation_and_rollback       
...
PASSED
tests/test_medium.py::test_10_shell_rollback
=== SHELL ROLLBACK TEST ===
OK: shell rollback reverts totals correctly
PASSED
tests/test_medium.py::test_11_kernel_rollback
